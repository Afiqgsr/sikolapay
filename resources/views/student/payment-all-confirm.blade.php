...
@section('title', 'Konfirmasi Pembayaran - SikolaPay')
...
<section class="payment-page payment-all-confirm-page">
    ...
    <div class="payment-header">
        ...
        <h2>Pembayaran Semua Tagihan</h2>
                    ...
                    <div class="account-information">
                        ...
                        <div class="transfer-note">
                            ...
                            <p>
                                ...
                                <strong>
                                    Total transfer harus sama persis
                                </strong>
                    ...
                    <div class="account-information">
                        ...
                        <div class="transfer-note">
                            ...
                            <p>
                                ...
                                harus dibayar sesuai total tagihan.
                ...
                <div class="summary-content">
                    ...
                    <div class="confirmation">
                        ...
                        <p>
                            ...
                            Anda menyatakan telah melakukan
    ...
    <div class="modal-box">
        ...
        <div class="modal-body">
            ...
            <input
                ...
                value="{{
                    $bankTransferMethods->first()->id
                    ?? $vaMethods->first()->id
                    ?? $qrisMethod?->id
                    ?? $ewalletMethods->first()->id
                    ?? ''
                }}"
            >
            ...
            <div class="modal-actions">
                ...
                <button
                    ...
                    class="btn-primary"
                    id="submitConfirm"
                    data-confirm-url="{{ route('student.payment.all.confirm.store') }}"
                >
                    Ya, Konfirmasi
                </button>
    ...
    <div class="modal-box">
        ...
        <div class="modal-body">
            ...
            <p>
                ...
                Seluruh pembayaran Anda telah diterima.
...
@push('scripts')
    ...
    @vite('resources/js/pages/student/payment-all-confirm.js')
