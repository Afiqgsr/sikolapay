...
@push('styles')
    @vite('resources/css/pages/guardian/payment.css')
@endpush
...
<section class="payment-page">
    ...
    <form
        method="POST"
        action="{{ route('guardian.payments.store') }}"
        enctype="multipart/form-data"
        id="guardianPaymentForm"
    >
        ...
        <input
            ...
            value="{{ $bankTransferMethods->first()->id
                ?? $vaMethods->first()->id
                ?? $qrisMethod?->id
                        ...
                        <div class="account-information">
                            ...
                            <div class="account-box">
                                ...
                                <div
                                    ...
                                    id="accountNumber"
                                >
                                    {{ $bankTransferMethods->first()->account_number
                        ...
                        <div class="account-information">
                            ...
                            <div class="account-box">
                                ...
                                <div
                                    ...
                                    id="vaAccountNumber"
                                >
                                    {{ $vaMethods->first()->account_number
    ...
    <div class="modal-box">
        ...
        <div class="modal-body">
            ...
            <p>
                ...
                Pastikan Anda telah melakukan pembayaran sebesar
...
@push('scripts')
    @vite('resources/js/pages/guardian/payment.js')
@endpush
